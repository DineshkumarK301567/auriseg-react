        ...
        <div className="relative z-10 w-full h-full flex items-start pt-32">
          <div className="w-full px-8 md:px-12 lg:px-16 xl:px-20">
            <div className="max-w-[800px]">
              {/* Healthcare Cybersecurity - Badge with Border & Icon */}
              <div className="mb-6">
                <div 
              ...
              >
                Patient Safety Starts<br />with Cyber Safety
              </h1>
              ...
              >
                Auriseg protects healthcare organizations against cyber threats without 
                disrupting clinical operations. Built for the care continuum.
              </p>

              {/* Buttons */}
              <div className="flex flex-wrap gap-4">
                <Link 
                  to="/get-security-assessment"
      ...
      >
        ...
        <div className="relative z-10 w-full flex flex-col items-center justify-start pt-6 px-6">
          <div className="text-center">
            {/* Healthcare Cybersecurity - Badge Mobile with Border & Icon */}
