  ...
  const caseStudies = [
    {
      ...
      description: "A regional physician group with 14 locations, no dedicated security team, and 200+ connected medical devices was audited for HIPAA compliance — 11 weeks before a state HIPAA audit.",
      challenge: [
        "No asset inventory for IoMT devices across 14 clinic locations",
        "Active Business Associate Agreement (BAA) violations with 3 vendors"
      ],
      solution: [
        "Deployed Azure IoT discovery and segmentation across all 14 sites in 3 weeks",
        "Executed emergency BAA compliance reviews and vendor risk remediation"
      ],
      impact: [
        { value: "100%", label: "HIPAA compliance score" },
        { value: "47s", label: "Threat detection and containment" },
        { value: "$0", label: "Downtime from cyber incidents" },
        { value: "3,000+", label: "Devices secured and monitored" }
      ],
