  ...
  const problems = [
    {
      ...
      description: "Attackers steal data and cause chaos, costing healthcare organizations up to $1.27M per day.",
      image: "/images/industries_navbar/healthcare/problem-ransomware.jpg",
    },
    {
      title: "IoMT Devices Multiply Exposure",
      description: "Connected medical devices create new attack vectors, with 82% of healthcare organizations experiencing IoT-related security incidents.",
      image: "/images/industries_navbar/healthcare/problem-iomt.jpg",
    },
    {
      title: "Regulatory Risk Is Accelerating",
      description: "HIPAA, GDPR, and other compliance requirements grow stricter, with fines reaching millions for non-compliance.",
      image: "/images/industries_navbar/healthcare/problem-regulatory.jpg",
    },
    {
      title: "Insider Threats Evade Detection",
      description: "Privileged access misuse and credential theft account for 60% of healthcare data breaches.",
