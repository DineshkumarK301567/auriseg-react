...
const FAQ = () => {
  ...
  const faqs = [
    {
      question: "Q1: How quickly can Auriseg get us HIPAA-compliant?",
      answer: "Timeline depends on your current posture. Most organizations see critical gaps remediated within 4–8 weeks. Full HIPAA Security Rule alignment — including documentation, controls, and tested IR procedures — typically takes 60–90 days."
    },
    {
      question: "Q2: Do you work with our existing EHR and clinical software vendors?",
    ...
    {
      question: "Q3: What makes healthcare cybersecurity different from general enterprise security?",
    ...
    {
      question: "Q4: We've already been breached once. Can Auriseg help us recover and prevent recurrence?",
