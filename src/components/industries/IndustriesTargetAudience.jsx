  ...
  const audiences = [
    {
      ...
      title: "Health Systems & Hospital Networks",
      description: "Auriseg secures complex, multi-site environments with EHR integrations and regulatory scrutiny without adding staff."
    },
    {
      image: "/images/industries_navbar/healthcare/audience-physician-groups.jpg",
      title: "Physician Groups & Specialty Networks",
      description: "Auriseg serves as your full security department for clinical data, billing, and portal management."
    },
    {
      image: "/images/industries_navbar/healthcare/audience-ambulatory.jpg",
      title: "Ambulatory Clinics & Provider Practices",
      description: "Auriseg ensures SaaS platforms with PHI meet HIPAA, SOC2, and security standards from design to deployment."
    },
    {
      image: "/images/industries_navbar/healthcare/audience-digital-health.jpg",
      title: "Digital Health & HealthTech Companies",
      description: "Auriseg provides comprehensive security protection for behavioral health and reduces risk of theft."
    }
  ];
      ...
      >
        <div className="w-full px-8 md:px-12 lg:px-16 xl:px-20">
          <div className="max-w-[1240px] mx-auto">
            ...
            >
              Built for every corner of the care continuum
            </h2>
              ...
              <div className="flex justify-center items-center gap-6 mt-12">
                <button
                  ...
                  className={`flex items-center justify-center transition-all duration-300 ${
                    isPrevDisabledDesktop ? 'opacity-30 cursor-not-allowed' : 'hover:opacity-80 cursor-pointer'
                  }`}
                  style={{
                    width: '40px',
                    height: '40px',
                ...
                <button
                  ...
                  className={`flex items-center justify-center transition-all duration-300 ${
                    isNextDisabledDesktop ? 'opacity-30 cursor-not-allowed' : 'hover:opacity-80 cursor-pointer'
                  }`}
                  style={{
                    width: '40px',
                    height: '40px',
        ...
        <div className="max-w-[375px] mx-auto">
          ...
          <div className="flex justify-center items-center gap-6 mt-8">
            <button
              ...
              className={`flex items-center justify-center transition-all duration-300 ${
                isPrevDisabledMobile ? 'opacity-30 cursor-not-allowed' : 'hover:opacity-80 cursor-pointer'
              }`}
              style={{
                width: '40px',
                height: '40px',
            ...
            <button
              ...
              className={`flex items-center justify-center transition-all duration-300 ${
                isNextDisabledMobile ? 'opacity-30 cursor-not-allowed' : 'hover:opacity-80 cursor-pointer'
              }`}
              style={{
                width: '40px',
                height: '40px',
