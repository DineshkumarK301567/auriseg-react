...
const IndustriesCompliance = () => {
  ...
  const complianceTabs = [
    {
      title: "MFA Mandate",
      description: "All systems accessing ePHI must use multi-factor authentication.",
    ...
    },
    {
      ...
      whatItRequires: "Audit all storage and transmission pathways; remediate wherever possible.",
    ...
    },
    {
      ...
      description: "Organizations must maintain a complete, current inventory of all hardware and software accessing ePHI.",
    ...
    <>
      ...
      <section
        ...
        style={{
          ...
          background: '#030407',
          padding: '48px 0'          /* ← was 80px, reduced top/bottom */
        }}
      >
          ...
          <div className="max-w-[1240px] mx-auto">
            ...
            <div
              style={{
                width: '100%',
                maxWidth: '1240px',
                padding: '24px 30px',  /* ← was 30px, slightly tighter */
                background: '#030407',
                border: '1px solid #444444',
