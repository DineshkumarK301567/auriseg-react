const CARDS = [
  {
    ...
    body: 'AI/ML-driven threat intelligence correlates behavioral signals across your environment to identify threat actors. Automated remediation works in real time.',
  },
  {
    id: 'comprehensive',
    icon: '/images/About Us/posture/comprehensive.png',
    title: 'Comprehensive &\nCustomized',
    body: "Every engagement is scoped to your sector's regulatory mandates and IT architecture. Compliance frameworks are integrated from day one.",
  },
  {
    id: 'soc',
    icon: '/images/About Us/posture/soc.png',
    title: 'Managed SOC\nOperations',
    body: '24/7 Incident Response, Digital Forensics, and vCISO Governance. Your attack surface is always monitored and ready to respond.',
  },
];
