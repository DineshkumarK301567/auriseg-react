      ...
      <div className="container-custom px-4 sm:px-6 md:px-8 relative z-10 flex flex-col items-center min-h-[650px] py-6 md:py-10">
        ...
        <div className="w-full max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <Link
              to="/contact"
              className="acta-btn-2 inline-flex items-center justify-center transition-all duration-300 hover:bg-[#FF5536]"
              style={{
                /* Desktop: 197×60 | Mobile: 278×48 */
                width: 'clamp(197px, 197px, 197px)',
                height: 'clamp(48px, 60px, 60px)',
