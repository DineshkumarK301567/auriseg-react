        ...
        <div className="relative z-10 w-full h-full flex items-center">
          <div className="w-full px-8 md:px-12 lg:px-16 xl:px-20">
            <div className="max-w-[900px]">
              {/* SOC Operations and Augmentation - Badge */}
              <div className="mb-8">
                <div 
              ...
              >
                ...
                >
                  SOC OPERATIONS AND AUGMENTATION
                </span>
              </div>
              </div>
              ...
              >
                Auriseg extends your security team with elite SOC analysts, AI-driven detection, 
                and 24/7/365 incident response — zero gaps.
              </p>

              {/* Buttons */}
              <div className="flex flex-wrap gap-4">
                <Link 
                  to="/activate-your-soc"
      ...
      <section className="md:hidden" style={{ 
        ...
        >
          ...
          <div className="relative z-10 w-full flex flex-col items-center justify-start pt-12 pb-12 px-6">
            {/* SOC Operations and Augmentation - Badge (Mobile) */}
