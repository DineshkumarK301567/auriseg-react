...
const SocEngagementModels = () => {
  const models = [
    {
      icon: "/icons/soc_augmentation/co-managed.png",
      title: "Co-Managed SOC",
      description: "Your team keeps control. Auriseg analysts operate as an embedded extension — sharing workloads, alerts, and escalations in real time."
    },
    {
      icon: "/icons/soc_augmentation/fully-managed.png",
      title: "Fully Managed SOC",
      description: "Offload it entirely. Auriseg handles detection, triage, response, and reporting — freeing your team to focus on strategy."
    },
    {
      icon: "/icons/soc_augmentation/soc-augmentation.png",
      title: "SOC Augmentation",
      description: "Staff the gaps. Inject deep expertise into your existing SOC — covering after-hours, overflow, or specialized threat domains as needed."
    }
  ];
...
export default SocEngagementModels;