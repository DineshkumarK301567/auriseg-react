...
const SocIntegrations = () => {
  const integrations = {
    siem: ['Microsoft Sentinel', 'Splunk', 'IBM QRadar', 'Elastic SIEM'],
    edr: ['CrowdStrike Falcon', 'SentinelOne', 'Microsoft Defender XDR', 'Palo Alto Cortex XDR'],
    firewall: ['Palo Alto NGFW', 'Fortinet FortiGate', 'Cisco Meraki', 'Check Point'],
    cloud: ['Microsoft Azure', 'AWS Security Hub', 'Google Chronicle', 'Cloudflare']
  };
        ...
        <div className="w-full px-8 md:px-12 lg:px-16 xl:px-20">
          <div className="max-w-[1240px] mx-auto">
            ...
            >
              ...
              >
                Auriseg integrates with your existing toolstack — no rip-and-replace required.
              </p>
            </div>
...
export default SocIntegrations;