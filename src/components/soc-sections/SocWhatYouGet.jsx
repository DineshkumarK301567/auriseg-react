  ...
  const cards = [
    {
      ...
      description: "Auriseg analysts monitor your clients' environments around the clock. Every alert is triaged, correlated, and escalated — with zero noise reaching your team."
    },
    {
      icon: "/icons/soc-augmentation/triage-escalation.png",
      title: "Triage & Escalation",
      description: "Every high-fidelity alert triggers a structured investigation. Auriseg analysts trace the full attack chain, confirm or dismiss threats, and deliver documented findings — not raw data dumps."
    },
    {
      icon: "/icons/soc-augmentation/reporting.png",
      title: "Reporting & White-Label",
      description: "When incidents are confirmed, Auriseg executes containment, coordinates remediation steps, and delivers a full post-incident report — reducing dwell time before damage compounds."
    }
  ];
      ...
      >
        <div className="w-full px-8 md:px-12 lg:px-16 xl:px-20">
          <div style={{ maxWidth: '1240px', margin: '0 auto' }}>
            ...
            >
              Every engagement includes continuous monitoring, analyst-led investigations, and platform-native response — purpose-built for MSP delivery at scale.
            </p>
